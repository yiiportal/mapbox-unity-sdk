...
namespace Mapbox.LocationModule.UnityLocationWrappers
{
	...
	/// <see cref="LocationAuthorizationBridge"/> so <c>LocationProviderFactory.Initialize</c>'s
	/// startup coroutine no longer trips Main Thread Checker against the deprecated
